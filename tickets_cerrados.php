...
// consulta para obtener info de los tickets con estado=cerrado o id_estado=3
$info_tickets = "SELECT tickets.id_ticket, tickets.titulo, tickets.estado, tickets.prioridad, 
                ...
                WHERE tickets.estado = 'cerrado' OR tickets.id_estado = 3";
...
<?php include 'modooscuro.php'; ?>
    ...
    <div class="contenido">
        <h1>Tickets Cerrados<img src="img/t_cerrado.png" alt="Tickets cerrados" width="40" height="40"></h1>
            ...
            while ($fila = $resultado_tickets->fetch_assoc()) {
                ...
                echo '<div class="acciones-ticket">';
                    ...
                    echo '<div class="formulario-categoria">';
                        ...
                        echo '</form>';
                    echo '</div>'; // Cierre div categorias

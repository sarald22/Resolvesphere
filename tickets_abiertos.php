...
// verifico si el usuario tiene sesión iniciada y es admin
...
// consulta para obtener info de los tickets con estado=abierto o id_estado=1
$info_tickets = "SELECT tickets.id_ticket, tickets.titulo, tickets.estado, tickets.prioridad, 
                ...
                WHERE tickets.estado = 'abierto' OR tickets.id_estado = 1";
...
<?php include 'modooscuro.php'; ?>
    ...
    <div class="contenido">
        <h1>Tickets Abiertos<img src="img/t_abierto.png" alt="Tickets Abiertos" width="40" height="40"></h1>
